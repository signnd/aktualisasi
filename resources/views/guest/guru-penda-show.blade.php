<x-guest-layout>
    <div class="py-6">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <!-- Back Button -->
            <div class="mb-6">
                <a href="{{ route('guest.guru-penda.index', request()->only('search','kabupaten_id','page')) }}" 
            ...
            <div class="bg-white dark:bg-zinc-800 rounded-lg shadow-lg overflow-hidden">
                ...
                <div class="p-6 space-y-6">
                    ...
                    <!-- Informasi Kontak -->
                    @if($guruPenda->email || $guruPenda->nama_sekolah_sd || $guruPenda->nama_sekolah_smp || $guruPenda->nama_sekolah_sma || $guruPenda->no_telp)
                    <div class="border-b pb-4 dark:border-zinc-700">
                        <h2 class="text-lg font-semibold text-gray-900 dark:text-white mb-3 flex items-center">
                            <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            @endphp
                            <div>
                                <p class="text-sm text-gray-500">SD tempat Mengajar</p>
                                <p class="font-medium">
                            ...
                            <div>
                                <p class="text-sm text-gray-500">Alamat SD tempat Mengajar</p>
                                <p class="font-medium">
                            ...
                            <div>
                                <p class="text-sm text-gray-500">SMP tempat Mengajar</p>
                                <p class="font-medium">
                            ...
                            <div>
                                <p class="text-sm text-gray-500">Alamat SMP tempat Mengajar</p>
                                <p class="font-medium">
                            ...
                            <div>
                                <p class="text-sm text-gray-500">SMA/SMK tempat Mengajar</p>
                                <p class="font-medium">
                            ...
                            <div>
                                <p class="text-sm text-gray-500">SMA tempat Mengajar</p>
                                <p class="font-medium">
                        ...
                        <div>
                            <p class="text-sm text-gray-500">Tanggal Sertifikasi</p>
                            <p class="font-medium">{{ $guruPenda->tgl_sertifikasii ?? '-' }}</p>
                        </div>
                        <div>
                            <p class="text-sm text-gray-500">Mata Pelajaran yang Tersertifikasi</p>
                        ...
                        <div>
                            <p class="text-sm text-gray-500">Link Sertifikat Sertifikasi</p>
