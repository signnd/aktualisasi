<x-guest-layout>
    <div class="py-6">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <!-- Back Button -->
            <div class="mb-6">
                <a href="{{ route('guest.majelis.index', array_merge(request()->only('search','kabupaten_id'), ['page' => request('page', session('majelis_page', 1))])) }}" 
            ...
            <div class="bg-white dark:bg-zinc-800 rounded-lg shadow-lg overflow-hidden">
                <!-- Header -->
                <div class="bg-gradient-to-r from-sky-700 to-sky-800 text-white p-6">
