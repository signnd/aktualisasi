...
<x-guest-layout>
    <div class="py-6">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <!-- Back Button -->
            <div class="mb-6">
                <a href="{{ route('guest.riab.index', array_merge(request()->only('search','kabupaten_id'), ['page' => request('page', session('riab_page', 1))])) }}" 
            ...
            <div class="bg-white dark:bg-zinc-800 rounded-lg shadow-lg overflow-hidden">
                <!-- Header -->
                <div class="bg-gradient-to-r from-indigo-600 to-indigo-800 text-white p-6 relative">
                    ...
                    <div class="border-b pb-4 dark:border-zinc-700">
                        ...
                        <div class="space-y-3">
                            @if($isGoogleDrive && $fileId)
                                ...
                                <div class="relative rounded-lg overflow-hidden border border-gray-300 dark:border-zinc-600 bg-gray-50 dark:bg-zinc-900">
                                    <img id="guest-main-image" 
                                         src="{{ $imageUrl }}" 
                                         alt="Foto {{ $riab->nama }}"
                                         class="w-full h-auto max-h-96 object-contain mx-auto"
                                         style="display: block;"
                                         onerror="showIframeViewer('guest-main-image', 'guest-iframe-viewer-main', '{{ $fileId }}')">
                                    
                                    <!-- Fallback: Google Drive Viewer (iframe) -->
                                    <iframe id="guest-iframe-viewer-main"
                            ...
                            @else
                                ...
                                <div class="relative rounded-lg overflow-hidden border border-gray-300 dark:border-zinc-600 bg-gray-50 dark:bg-zinc-900 p-10 text-center">
