            ...
            <div class="p-6 space-y-6"> 
                ...
                <div class="border-b pb-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <p class="font-medium">
                                <span class="px-2 py-1 rounded text-sm {{ $smb->status_verifikasi == 'TRUE' ? 'bg-blue-100 text-blue-800' : 'bg-gray-50 text-gray-800 dark:text-gray-100' }}">
                ...
                <div class="mt-8 col-span-2">
                    ...
                    <div class="bg-white dark:bg-zinc-900 px-4 py-3 border-t border-gray-200 sm:px-6">
                        {{ $siswas->fragment('data-siswa')->links() }}
                    </div>
                @endif
