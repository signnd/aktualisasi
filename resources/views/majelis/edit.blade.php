<x-app-layout>
    <x-slot name="header">
        <h2 class="text-xl font-semibold leading-tight h4: text-gray-900 dark:text-gray-200 ">
            {{ __('Tambah Majelis') }}
        </h2>
    </x-slot>
    ...
    <div class="py-6">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-gray-50 dark:bg-zinc-900 border border-gray-800 dark:border-gray-600 dark:border-gray-300 shadow-lg rounded-lg overflow-hidden">                
                <!-- Header -->
                ...
                <form action="{{ route('majelis.update', $majelis->id) }}" method="POST" class="p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 py-3">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="keterangan" rows="4"
                                       class="w-full px-3 py-2 border border-gray-400 dark:bg-zinc-800 dark:border-zinc-600 dark:text-white bg-white hover:shadow-md transition motion-reduce:transition-none rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('keterangan', $majelis->keterangan) }}</textarea>
                            </div>
                                <div>
                    ...
                    <div class="flex justify-between items-center pt-6 border-t">
                        <a href="{{ route('majelis.index', ['page' => session('majelis_page', 1)]) }}" 
