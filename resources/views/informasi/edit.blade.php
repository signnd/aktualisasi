                ...
                <form action="{{ route('informasi.update', $informasi->id) }}" method="POST" class="p-6">
                    ...
                    <div class="mb-8">
                        ...
                        <div>
                            ...
                            <textarea name="teks" required class="w-full px-3 py-2 border border-gray-800 dark:border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('teks', $informasi->teks) }}</textarea>
                        </div>
