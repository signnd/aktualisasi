                ...
                <form action="{{ route('informasi.store') }}" method="POST" class="p-6">
                    ...
                    <div class="mb-8">
                        ...
                        <div>
                            ...
                            <textarea name="teks" required class="w-full h-40 px-3 py-2 border border-gray-400 dark:bg-zinc-800 dark:border-zinc-600 dark:text-white bg-white hover:shadow-md transition motion-reduce:transition-none rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"></textarea>
                        </div>
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            <div>
                                ...
                                <input type="date" value="{{ \Carbon\Carbon::now()->format('Y-m-d') }}"
                                       class="w-full px-3 py-2 border border-gray-400 hover:shadow-md transition motion-reduce:transition-none rounded-md bg-gray-200 dark:bg-gray-700">
                            </div>
                        </div>
                    </div>
                </div>
