...
@endphp
    ...
    <div class="py-6">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-gray-50 dark:bg-gray-900 border border-gray-400 shadow-lg rounded-lg overflow-hidden">
                ...
                <form action="{{ route('riab.update', $riab->id) }}" method="POST" class="p-6">
                    ...
                    <!-- Informasi Lokasi -->
                    <div class="mb-8">
                        <h4 class="text-lg font-semibold text-gray-950 dark:text-gray-100 mb-4 pb-2 border-b-2 border-blue-500 flex items-center">
                            <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="nama" value="{{ old('nama', $riab->nama) }}" required
                                       class="w-full px-3 py-2 border border-gray-400 bg-white dark:bg-gray-600/80 dark:bg-gray-600/80 hover:shadow-md transition motion-reduce:transition-none rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                @if(auth()->user()->user_role === 'admin')
                                    ...
                                    <select id="kabupaten_id" name="kabupaten_id" required
                                        class="w-full px-3 py-2 border border-gray-400 bg-white dark:bg-gray-700/90 text-black dark:text-gray-100 rounded-lg hover:shadow-md transition motion-reduce:transition-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-black bg-gray-300">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="alamat" rows="2" required
                                       class="w-full px-3 py-2 border border-gray-400 bg-white dark:bg-gray-600/80 hover:shadow-md transition motion-reduce:transition-none rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('alamat', $riab->alamat) }}</textarea>
                            </div>
                            <div>
                    ...
                    <!-- Informasi Umum -->
                    <div class="mb-8">
                        <h4 class="text-lg font-semibold text-gray-950 dark:text-gray-100 mb-4 pb-2 border-b-2 border-green-500 flex items-center">
                            <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <!-- Informasi Kontak -->
                    <div class="mb-8">
                        <h4 class="text-lg font-semibold text-gray-950 dark:text-gray-100 mb-4 pb-2 border-b-2 border-purple-500 flex items-center">
                            <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div class="mb-8">
                        <h4 class="text-lg font-semibold text-gray-950 dark:text-gray-100 mb-4 pb-2 border-b-2 border-orange-500 flex items-center">
                            <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <textarea name="deskripsi" rows="4"
                                       class="w-full px-3 py-2 border border-gray-400 bg-white dark:bg-gray-600/80 hover:shadow-md transition motion-reduce:transition-none rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('deskripsi', $riab->deskripsi) }}</textarea>
                            </div>
                            <div>
                    ...
                    <!-- Informasi Detail -->
                    <div class="mb-8">
                        <h4 class="text-lg font-semibold text-gray-950 dark:text-gray-100 mb-4 pb-2 border-b-2 border-red-500 flex items-center">
                            <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="lg:pt-7">
                                <label class="flex items-center space-x-2 cursor-pointer p-2 border border-gray-400 bg-white dark:bg-gray-600/80 hover:shadow-md transition motion-reduce:transition-none rounded-md hover:bg-gray-50">
                    ...
                    <!-- Riwayat Bantuan -->
                    <div class="mb-8">
                        <h4 class="text-lg font-semibold text-gray-950 dark:text-gray-100 mb-4 pb-2 border-b-2 border-indigo-500 flex items-center">
                            <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <!-- Fasilitas -->
                    <div class="mb-8">
                        <h4 class="text-lg font-semibold text-gray-950 dark:text-gray-100 mb-4 pb-2 border-b-2 border-pink-500 flex items-center">
                            <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                            <label class="flex items-center space-x-2 p-3 border border-gray-400 bg-white dark:bg-gray-600/80 hover:shadow-md hover:bg-gray-50 transition motion-reduce:transition-none rounded-md cursor-pointer">
                    ...
                    <div class="mb-8">
                        <h4 class="text-lg font-semibold text-gray-950 dark:text-gray-100 mb-4 pb-2 border-b-2 border-teal-500 flex items-center">
                            <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <!-- Informasi Lainnya -->
                    <div class="mb-8">
                        <h4 class="text-lg font-semibold text-gray-950 dark:text-gray-100 mb-4 pb-2 border-b-2 border-gray-500 flex items-center">
                            <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
