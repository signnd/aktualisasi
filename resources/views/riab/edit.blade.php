                            ...
                            <div>
                                ...
                                @if(auth()->user()->user_role === 'admin')
                                    ...
                                    <select id="kabupaten_id" name="kabupaten_id" required
                                        class="w-full px-3 py-2 border border-gray-400 bg-white dark:bg-zinc-800 text-black dark:text-gray-100 rounded-lg hover:shadow-md transition motion-reduce:transition-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                ...
                                @else
                                    ...
                                    <select id="kabupaten_id" name="kabupaten_id" required disabled
                                        class="w-full px-3 py-2 border border-gray-400 bg-white dark:bg-zinc-800 text-black dark:text-gray-100 hover:shadow-md transition motion-reduce:transition-none rounded-md cursor-not-allowed">
                                        @foreach($kabupaten as $k)
