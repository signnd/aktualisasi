            ...
            <div class="flex-1 space-y-8">
                ...
                <div class="border-b dark:border-gray-700 pb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-8">
                        <div>
                            <p class="text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider mb-1">Nama Lengkap</p>
                            <p class="text-gray-900 dark:text-gray-100 font-medium">{{ $guruPenda->nama_guru }}</p>
                        </div>
                        <div>
                            <p class="text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider mb-1">NIP</p>
                    ...
                    <div class="border-b dark:border-gray-700 pb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-8">
                            ...
                            <div>
                                <p class="text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider mb-1">SD tempat Mengajar</p>
                                <div class="space-y-1">
                                    @forelse($nama_sekolah_sd as $idx => $nama)
                                        <p class="text-gray-900 dark:text-gray-100 font-medium">
                                            {{ $nama }}
                                        </p>
                                        <span class="text-gray-600 dark:text-gray-400 text-xs font-normal">{{ $alamat_sekolah_sd[$idx] ?? '-' }}</span>
                                    @empty
                            ...
                            <div>
                                <p class="text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider mb-1">SMP tempat Mengajar</p>
                                <div class="space-y-1">
                                    @forelse($nama_sekolah_smp as $idx => $nama)
                                        <p class="text-gray-900 dark:text-gray-100 font-medium">
                                            {{ $nama }}
                                        </p>
                                         <span class="text-gray-600 dark:text-gray-400 text-xs font-normal">{{ $alamat_sekolah_smp[$idx] ?? '-' }}</span>
                                    @empty
                                        <p class="text-gray-900 dark:text-gray-100 font-medium">-</p>
                                    @endforelse
                                </div>
                            ...
                            <div>
                                <p class="text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider mb-1">SMA/SMK tempat Mengajar</p>
                                <div class="space-y-1">
                                    @forelse($nama_sekolah_sma as $idx => $nama)
                                        <p class="text-gray-900 dark:text-gray-100 font-medium">
                                            {{ $nama }} 
                                        </p>
                                        <span class="text-gray-600 dark:text-gray-400 text-xs font-normal">{{ $alamat_sekolah_sma[$idx] ?? '-' }}</span>
                                    @empty
                                        <p class="text-gray-900 dark:text-gray-100 font-medium">-</p>
                                    @endforelse
                                </div>
                            ...
                            <div>
                                <p class="text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider mb-1">Sertifikasi</p>
                                <p class="text-gray-900 dark:text-gray-100 font-medium">{{ $guruPenda->sertifikasi ?? '-' }}</p>
                            </div>
                            <div>
                                <p class="text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider mb-1">Tgl Sertifikasi</p>
                                <p class="text-gray-900 dark:text-gray-100 font-medium">{{ $guruPenda->tgl_sertifikasi ?? '-' }}</p>
                            </div>
                            <div>
                                <p class="text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider mb-1">Mapel Sertifikasi</p>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-8">
                            <div>
                                <p class="text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider mb-1">Jumlah Siswa</p>
                                <p class="text-gray-900 dark:text-gray-100 font-medium font-mono text-lg">{{ $guruPenda->jml_siswa ? number_format($guruPenda->jml_siswa) : '0' }} <span class="text-xs text-gray-600 dark:text-gray-400 font-sans">Siswa</span></p>
                            </div>
                            <div>
