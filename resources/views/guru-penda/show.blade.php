            ...
            <div class="p-6 space-y-6"> <!-- informasi -->
                ...
                <div class="border-b pb-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                        <div>
                            <p class="text-sm text-gray-300">NIP</p>
                            <p class="font-medium">{{ $guruPenda->nip ?? '-' }}</p>
                        </div>
                        <p class="text-sm text-gray-300">NIK</p>
                        <p class="font-medium">{{ $guruPenda->nik ?? '-' }}</p>
                    </div>
                    <div>
                        <p class="text-sm text-gray-300">NRG</p>
                        <p class="font-medium">{{ $guruPenda->nrg ?? '-' }}</p>
                    </div>
                    <div>
                        <p class="text-sm text-gray-300">Jenis Kelamin</p>
                        <p class="font-medium">{{ $guruPenda->jenis_kelamin ?? '-' }}</p>
                    </div>
                    <div>
                        <p class="text-sm text-gray-300">Tempat/Tanggal Lahir</p>
                    ...
                    <div>
                        <p class="text-sm text-gray-300">Kabupaten/Kota</p>
                ...
                <div class="border-b pb-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <p class="text-sm text-gray-300">Link Foto</p>
                            @if($guruPenda->foto)
                            <div>
                ...
                <div class="border-b pb-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <p class="font-medium">
                                <span class="px-2 py-1 rounded text-sm {{ $guruPenda->status_verifikasi == 'TRUE' ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-100' }}">
