        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-gray-50 dark:bg-gray-900 border border-gray-300 shadow-lg rounded-lg overflow-hidden">
                ...
                <div class="bg-gradient-to-r from-green-600 to-green-800 text-white p-6">
                    <h3 class="text-2xl font-bold">Edit Data Guru Pendidikan Agama Buddha</h3>
                </div>

                <form action="{{ route('guru-penda.update', $guruPenda->id) }}" method="POST" class="p-6">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="flex items-center space-x-4 mt-2">
                                    <label class="flex items-center">
                                        <input type="radio" name="jenis_kelamin" value="Laki-laki"
                                               class="mr-2 text-blue-600 focus:ring-blue-500" {{ old('jenis_kelamin', $guruPenda->jenis_kelamin) == 'Laki-laki' ? 'checked' : '' }}>
                                        <span>Laki-laki</span>
                                    </label>
                                    <label class="flex items-center">
                            ...
                            <div>
                                ...
                                <textarea name="alamat" rows="2" 
                                       class="w-full px-3 py-2 border border-gray-400 bg-white hover:shadow-md transition motion-reduce:transition-none rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('alamat', $guruPenda->alamat) }}</textarea>
                            </div>
                            <div>
                                ...
                                <select id="kabupaten_id" name="kabupaten_id" required
                                    class="w-full px-3 py-2 border border-gray-400 bg-white hover:shadow-md transition motion-reduce:transition-none rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent text-black bg-gray-50 dark:bg-gray-300">
                            ...
                            <div>
                                ...
                                <div class="flex flex-wrap gap-3">
                                    ...
                                    <label class="flex items-center">
                                        <input type="radio" name="status_pegawai" value="PPPK" {{ old('status_pegawai', $guruPenda->status_pegawai) == 'PPPK' ? 'checked' : '' }}
                                    ...
                                    <label class="flex items-center">
                                        <input type="radio" name="status_pegawai" value="Nonaktif" {{ old('status_pegawai', $guruPenda->status_pegawai) == 'Nonaktif' ? 'checked' : '' }}
                                               class="mr-2 text-gray-600 focus:ring-gray-500">
                                        <span>Nonaktif</span>
                                    </label>
                                </div>
            ...
            <div class="mb-8" x-data="{ 
                sekolahSD: {{ json_encode(json_decode($guruPenda->nama_sekolah_sd ?? '[]', true) ?: ['']) }}, 
                alamatSD: {{ json_encode(json_decode($guruPenda->alamat_sekolah_sd ?? '[]', true) ?: ['']) }},
                sekolahSMP: {{ json_encode(json_decode($guruPenda->nama_sekolah_smp ?? '[]', true) ?: ['']) }}, 
                alamatSMP: {{ json_encode(json_decode($guruPenda->alamat_sekolah_smp ?? '[]', true) ?: ['']) }},
                ...
                <div class="mb-8">
                                ...
                                <div class="flex gap-3">
                                    <label class="flex items-center">
                                        <input type="radio" name="status_verifikasi" value="TRUE"
                                               class="mr-2 text-blue-600 focus:ring-blue-500" {{ old('status_verifikasi', $guruPenda->status_verifikasi) == 'TRUE' ? 'checked' : '' }}>
                                        <span>Terverifikasi</span>
                                    </label>
                                    <label class="flex items-center">
                                        <input type="radio" name="status_verifikasi" value="FALSE"
                                               class="mr-2 text-gray-600 focus:ring-gray-500" {{ old('status_verifikasi', $guruPenda->status_verifikasi) == 'FALSE' ? 'checked' : '' }}>
                    ...
                    <div class="flex justify-between items-center pt-6 border-t">
                        <a href="{{ route('guru-penda.index', ['page' => $page ?? 1]) }}" 
