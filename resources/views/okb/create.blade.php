        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-gray-50 dark:bg-zinc-900 border border-gray-300 shadow-lg rounded-lg overflow-hidden">
                ...
                <div class="bg-gradient-to-r from-green-600 to-green-800 text-white p-6">
                    <h3 class="text-2xl font-bold">Tambah Data Organisasi Keagamaan Buddha (OKB)</h3>
                </div>

                <form action="{{ route('okb.store') }}" method="POST" class="p-6">
                    @csrf
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="nama_okb" required
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <select id="jenis_kelembagaan" name="jenis_kelembagaan" required
                                    class="w-full px-3 py-2 border border-gray-400 dark:bg-zinc-800 dark:border-zinc-600 dark:text-white bg-white hover:shadow-md transition motion-reduce:transition-none rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent text-black bg-gray-300">
                                    <option value="">-- Pilih Jenis Kelembagaan --</option>
                                        <option value="Majelis/Perkumpulan/Perhimpunan Keagamaan Buddha" id="10">Majelis/Perkumpulan/Perhimpunan Keagamaan Buddha</option>
                                        <option value="Yayasan Keagamaan Buddha" id="20">Yayasan Keagamaan Buddha</option>
                                        <option value="Organisasi Keagamaan Buddha" id="30">Organisasi Keagamaan Buddha</option>
                                        <option value="Organisasi Wanita Keagamaan Buddha" id="31">Organisasi Wanita Keagamaan Buddha</option>
