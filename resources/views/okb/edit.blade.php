                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="alamat" rows="2" required
                                       class="w-full px-3 py-2 border border-gray-400 dark:bg-zinc-800 dark:border-zinc-600 dark:text-white bg-white hover:shadow-md transition motion-reduce:transition-none rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('alamat', $okb->alamat) }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <div class="flex gap-3">
                                    <label class="flex items-center">
                                        <input type="radio" name="status_verifikasi" value="approved" {{ old('status_verifikasi', $okb->status_verifikasi) == 'approved' ? 'checked' : ''  }}
                                               class="mr-2 text-blue-600 focus:ring-blue-500">
                                        <span>Terverifikasi/Approved</span>
                                    </label>
                                    <label class="flex items-center">
                                        <input type="radio" name="status_verifikasi" value="pending" {{ old('status_verifikasi', $okb->status_verifikasi) == 'pending' ? 'checked' : ''  }}
                                               class="mr-2 text-gray-600 focus:ring-gray-500">
                                        <span>Pending</span>
                                    </label>
                                    <label class="flex items-center">
                                        <input type="radio" name="status_verifikasi" value="rejected" {{ old('status_verifikasi', $okb->status_verifikasi) == 'rejected' ? 'checked' : ''  }}
                                               class="mr-2 text-red-600 focus:ring-red-500">
                                        <span>Ditolak</span>
                                    </label>
                                </div>
