<x-app-layout>
    ...
    <div class="py-6">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-zinc-900 border border-gray-600 dark:border-gray-300 shadow-lg rounded-lg overflow-hidden">
                
                <!-- Header -->
                <div class="bg-gradient-to-r from-green-600 to-green-800 text-white p-6">
                    <h3 class="text-2xl font-bold">Edit Data Pusdiklat</h3>
                </div>

                <form action="{{ route('pusdiklat.update', $pusdiklat->id) }}" method="POST" class="p-6">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="alamat" rows="2" required
                                       class="w-full px-3 py-2 border border-gray-400 dark:bg-zinc-800 dark:border-zinc-600 dark:text-white bg-white hover:shadow-md transition motion-reduce:transition-none rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('alamat', $pusdiklat->alamat) }}</textarea>
                            </div>
                                                        <div>
                                <label class="block text-sm font-medium text-gray-800 dark:text-gray-100 mb-1">Latitude</label>
                                <input type="text" name="latitude" value="{{ old('latitude', $pusdiklat->latitude) }}"
                                       class="w-full px-3 py-2 border border-gray-400 dark:bg-zinc-800 dark:border-zinc-600 dark:text-white bg-white hover:shadow-md transition motion-reduce:transition-none rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-800 dark:text-gray-100 mb-1">Longitude</label>
                                <input type="text" name="longitude" value="{{ old('longitude', $pusdiklat->longitude) }}"
                                       class="w-full px-3 py-2 border border-gray-400 dark:bg-zinc-800 dark:border-zinc-600 dark:text-white bg-white hover:shadow-md transition motion-reduce:transition-none rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                            </div>
                            <div class="md:col-span-2">
                                <label class="block text-sm font-medium text-gray-800 dark:text-gray-100 mb-1">Didirikan</label>
                                <input type="text" name="berdiri" value="{{ old('berdiri', $pusdiklat->berdiri) }}"
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="izop_1" value="{{ old('izop_1', $pusdiklat->izop_1) }}"
                                       class="w-full px-3 py-2 border border-gray-400 dark:bg-zinc-800 dark:border-zinc-600 dark:text-white bg-white hover:shadow-md transition motion-reduce:transition-none rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-800 dark:text-gray-100 mb-1">PPJG 1</label>
                                <input type="text" name="ppjg_1" value="{{ old('ppjg_1', $pusdiklat->ppjg_1) }}"
                                       class="w-full px-3 py-2 border border-gray-400 dark:bg-zinc-800 dark:border-zinc-600 dark:text-white bg-white hover:shadow-md transition motion-reduce:transition-none rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-800 dark:text-gray-100 mb-1">PPJG 2</label>
                                <input type="text" name="ppjg_2" value="{{ old('ppjg_2', $pusdiklat->ppjg_2) }}"
                                       class="w-full px-3 py-2 border border-gray-400 dark:bg-zinc-800 dark:border-zinc-600 dark:text-white bg-white hover:shadow-md transition motion-reduce:transition-none rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-800 dark:text-gray-100 mb-1">No. Statistik</label>
                                <input type="text" name="no_statistik" value="{{ old('no_statistik', $pusdiklat->no_statistik) }}"
                                       class="w-full px-3 py-2 border border-gray-400 dark:bg-zinc-800 dark:border-zinc-600 dark:text-white bg-white hover:shadow-md transition motion-reduce:transition-none rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-800 dark:text-gray-100 mb-1">Tahun IZOP</label>
                                <input type="text" name="th_izop" value="{{ old('th_izop', $pusdiklat->th_izop) }}"
                                       class="w-full px-3 py-2 border border-gray-400 dark:bg-zinc-800 dark:border-zinc-600 dark:text-white bg-white hover:shadow-md transition motion-reduce:transition-none rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-800 dark:text-gray-100 mb-1">Tanggal IZOP</label>
                                <input type="date" name="tgl_izop" value="{{ old('tgl_izop', $pusdiklat->tgl_izop) }}"
                                       class="w-full px-3 py-2 border border-gray-400 dark:bg-zinc-800 dark:border-zinc-600 dark:text-white bg-white hover:shadow-md transition motion-reduce:transition-none rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-800 dark:text-gray-100 mb-1">Masa IZOP</label>
                                <input type="text" name="masa_izop" value="{{ old('masa_izop', $pusdiklat->masa_izop) }}"
                                       class="w-full px-3 py-2 border border-gray-400 dark:bg-zinc-800 dark:border-zinc-600 dark:text-white bg-white hover:shadow-md transition motion-reduce:transition-none rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-800 dark:text-gray-100 mb-1">Bapen</label>
                                <input type="text" name="bapen"
                                       placeholder="" value="{{ old('bapen', $pusdiklat->bapen) }}"
                                       class="w-full px-3 py-2 border border-gray-400 dark:bg-zinc-800 dark:border-zinc-600 dark:text-white bg-white hover:shadow-md transition motion-reduce:transition-none rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                            </div>
                            <div>
                                ...
                                <textarea name="alamat_bapen" rows="2"
                                       class="w-full px-3 py-2 border border-gray-400 dark:bg-zinc-800 dark:border-zinc-600 dark:text-white bg-white hover:shadow-md transition motion-reduce:transition-none rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('alamat_bapen', $pusdiklat->alamat_bapen) }}</textarea>
                            </div>
                            <div>
                                ...
                                @else
                                    ...
                                    <select id="kabupaten_id" name="kabupaten_id" required disabled
                                        class="w-full px-3 py-2 border border-gray-400 dark:bg-zinc-800 dark:border-zinc-600 dark:text-white bg-white hover:shadow-md transition motion-reduce:transition-none rounded-md bg-gray-400 text-gray-700 cursor-not-allowed">
                            ...
                            <div>
                                ...
                                <input type="text" name="nama_pic" value="{{ old('nama_pic', $pusdiklat->nama_pic) }}"
                                       class="w-full px-3 py-2 border border-gray-400 dark:bg-zinc-800 dark:border-zinc-600 dark:text-white bg-white hover:shadow-md transition motion-reduce:transition-none rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-800 dark:text-gray-100 mb-1">No. Telp/HP/WhatsApp</label>
                                <input type="text" name="no_hp" value="{{ old('no_hp', $pusdiklat->no_hp) }}"
                                       class="w-full px-3 py-2 border border-gray-400 dark:bg-zinc-800 dark:border-zinc-600 dark:text-white bg-white hover:shadow-md transition motion-reduce:transition-none rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                            </div>
                                <div>
                                <label class="block text-sm font-medium text-gray-800 dark:text-gray-100 my-1">Status Eksisting</label>
                                <div class="flex gap-3">
                                    <label class="flex items-center">
                                        <input type="radio" name="eksisting" value="Aktif" {{ old('eksisting', $pusdiklat->eksisting) == 'Aktif' ? 'checked' : '' }}
                                               class="mr-2 text-green-600 focus:ring-green-500">
                                        <span>Aktif</span>
                                    </label>
                                    <label class="flex items-center">
                                        <input type="radio" name="eksisting" value="Tidak Aktif"  {{ old('eksisting', $pusdiklat->eksisting) == 'Tidak Aktif' ? 'checked' : '' }}
                            ...
                            <div>
                                ...
                                <input type="date" name="tgl_update" value="{{ $pusdiklat->tgl_update ? \Carbon\Carbon::now()->format('Y-m-d') : '-' }}"
                            ...
                            <div>
                                ...
                                <div class="flex gap-3">
                                    <label class="flex items-center">
                                        <input type="radio" name="status_verifikasi" value="TRUE" {{ old('status_verifikasi', $pusdiklat->status_verifikasi) == 'TRUE' ? 'checked' : '' }}
                                               class="mr-2 text-blue-600 focus:ring-blue-500">
                                        <span>Terverifikasi</span>
                                    </label>
                                    <label class="flex items-center">
                                        <input type="radio" name="status_verifikasi" value="FALSE" {{ old('status_verifikasi', $pusdiklat->status_verifikasi) == 'FALSE' ? 'checked' : '' }}
                                               class="mr-2 text-gray-600 focus:ring-gray-500">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="md:col-span-2">
                                ...
                                <div class="flex flex-wrap gap-3">
                                    ...
                                    <label class="flex items-center">
                                        <input type="radio" name="kondisi" value="Baik"  @checked(old('kondisi', $pusdiklat->kondisi) == 'Baik')
                                               class="mr-2 text-blue-600 focus:ring-blue-500">
                                        <span>Baik</span>
                                    </label>
                                    <label class="flex items-center">
                                        <input type="radio" name="kondisi" value="Rusak Ringan"  @checked(old('kondisi', $pusdiklat->kondisi) == 'Rusak Ringan')
                                               class="mr-2 text-yellow-600 focus:ring-yellow-500">
                                        <span>Rusak Ringan</span>
                                    </label>
                                    <label class="flex items-center">
                                        <input type="radio" name="kondisi" value="Rusak Sedang"  @checked(old('kondisi', $pusdiklat->kondisi) == 'Rusak Sedang')
                                               class="mr-2 text-orange-600 focus:ring-orange-500">
                                        <span>Rusak Sedang</span>
                                    </label>
                                    <label class="flex items-center">
                                        <input type="radio" name="kondisi" value="Rusak Berat"  @checked(old('kondisi', $pusdiklat->kondisi) == 'Rusak Berat')
                                               class="mr-2 text-red-600 focus:ring-red-500">
                            ...
                            <div>
                                ...
                                <input type="url" name="foto" 
                                       placeholder="https://..." value="{{ old('foto', $pusdiklat->foto) }}"
                                       class="w-full px-3 py-2 border border-gray-400 dark:bg-zinc-800 dark:border-zinc-600 dark:text-white bg-white hover:shadow-md transition motion-reduce:transition-none rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-800 dark:text-gray-100 my-2">Jumlah Siswa</label>
                                <input type="number" name="jml_siswa" value="{{ old('jml_siswa', $pusdiklat->jml_siswa) }}"
                                       class="w-full px-3 py-2 border border-gray-400 dark:bg-zinc-800 dark:border-zinc-600 dark:text-white bg-white hover:shadow-md transition motion-reduce:transition-none rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="url" name="link_berita_acara_nonaktif"
                                       placeholder="https://..." value="{{ old('link_berita_acara_nonaktif', $pusdiklat->link_berita_acara_nonakti) }}"
                                       class="w-full px-3 py-2 border border-gray-400 dark:bg-zinc-800 dark:border-zinc-600 dark:text-white bg-white hover:shadow-md transition motion-reduce:transition-none rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                            </div>
                        </div>
                    </div>
