        ...
        <div class="flex flex-col sm:flex-row w-full justify-between gap-4">
            <select wire:model.live="kabupaten_id"
                ...
                <input type="text" 
                   ...
                   placeholder="Cari nama vihara, alamat, deskripsi, kecamatan..."
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-200 dark:bg-zinc-700">
                    <tr>
                        ...
                        <button wire:click="sortBy('nama')" class="flex items-center hover:text-blue-400 transition">
                        Nama RIAB
                        @if($sortField === 'nama')
                            @if($sortDirection === 'asc')
                                <svg class="w-4 h-4 ml-1" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    @forelse($riabs as $index => $riab)
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                            ...
                            <td class="px-6 py-4 whitespace">
                                ...
                                <div class="text-xs text-gray-500 dark:text-gray-200">{{ $riab->alamat ?? '-' }}</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                <div class="flex justify-center space-x-2">
                                    ...
                                    <form action="{{ route('riab.destroy', $riab) }}" method="POST" 
                        ...
                        <td colspan="6" class="text-center py-6 text-gray-500 dark:text-gray-400 italic">
                            ...
                            @else
                                <div class="flex flex-col items-center justify-center text-gray-500">
                                    ...
                                    <p class="text-lg font-medium">Belum ada data Rumah Ibadah Agama Buddha</p>
                                    <p class="text-sm mt-1">Klik tombol "Tambah RIAB" untuk menambahkan data baru</p>
                                </div>
                            @endif
                        </td>
                    </tr>
