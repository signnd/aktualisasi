        ...
        <div class="bg-white dark:bg-zinc-800 rounded-lg shadow hover:shadow-xl hover:bg-gray-100 dark:hover:bg-zinc-700 transition-all duration-300 overflow-hidden">
            ...
            <div class="p-4 space-y-3">
                ...
                <div class="flex items-start">
                    ...
                    <div class="text-sm">
                        <p class="font-medium text-gray-900 dark:text-white">{{ $y->kabupaten->kabupaten ?? '-' }}</p>
                    </div>
                </div>
                ...
                <div class="flex items-start">
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400 line-clamp-3">{{ $y->alamat }}</p>
                </div>
                @endif
                ...
                <div class="flex items-start">
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400">{{ $y->ketua }}</p>
                </div>
                @endif
            </div>
        </a>
