<div>
    ...
    <div class="bg-gradient-to-r from-emerald-700 to-emerald-800 text-white rounded-lg shadow-lg p-8 mb-6">
        <h1 class="text-3xl font-bold mb-2">Pusdiklat</h1>
        <p class="text-emerald-100 mb-6">Database Pusdiklat Agama Buddha di Provinsi Bali</p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="bg-white/10 backdrop-blur rounded-lg p-4">
                <div class="flex items-center">
                    ...
                    <div>
                        <p class="text-sm text-emerald-100">Total Pusdiklat</p>
                        <p class="text-2xl font-bold">{{ number_format($totalPusdiklat) }}</p>
                    </div>
                </div>
            </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        @forelse($pusdiklats as $pusdiklat)
        <div class="bg-white dark:bg-zinc-800 rounded-lg shadow hover:shadow-xl hover:bg-gray-400 dark:hover:bg-zinc-700 transition-shadow duration-300 overflow-hidden">
            <a href="{{ route('guest.pusdiklat.show', $pusdiklat) }}" >
            <!-- Header Card -->
            <div class="bg-gradient-to-r from-emerald-600 to-emerald-800 text-white p-4">
                <h3 class="font-bold text-lg truncate" title="{{ $pusdiklat->nama }}">{{ $pusdiklat->nama }}</h3>
            </div>
            ...
            <div class="p-4 space-y-3">
                ...
                <div class="flex items-start">
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400 line-clamp-3">{{ $pusdiklat->alamat }}</p>
                </div>
                @endif
                ...
                <div class="flex items-start">
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400">{{ $pusdiklat->no_statistik }}</p>
                </div>
                @endif
            </div>
        </a>
