<div>
    ...
    <div class="bg-gradient-to-r from-purple-600 to-purple-800 text-white rounded-lg shadow-lg p-8 mb-6">
        <h1 class="text-3xl font-bold mb-2">Tenaga Kependidikan Agama Buddha</h1>
        <p class="text-purple-100 mb-6">Database Tenaga Kependidikan di Provinsi Bali</p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="bg-white/10 backdrop-blur rounded-lg p-4">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold">{{ number_format($totalTendik) }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white/10 backdrop-blur rounded-lg p-4">
                <div class="flex items-center">
                    ...
                    <div>
                        <p class="text-sm text-purple-100">Kabupaten/Kota</p>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white dark:bg-zinc-800 rounded-lg shadow hover:shadow-xl hover:bg-gray-200 dark:hover:bg-zinc-700 transition-shadow duration-300 overflow-hidden">
            <a href="{{ route('guest.tendik.show', $tendik) }}" >
            <!-- Header Card -->
            <div class="bg-gradient-to-r from-purple-500 to-purple-600 text-white p-4">
                <h3 class="font-bold text-lg truncate" title="{{ $tendik->nama_tendik }}">{{ $tendik->nama_tendik }}</h3>
            </div>
            ...
            <div class="p-4 space-y-3">
                ...
                <div class="flex items-start">
                    ...
                    <div class="text-sm">
                        <p class="font-medium text-gray-900 dark:text-white">{{ $tendik->kabupaten->kabupaten ?? '-' }}</p>
                    </div>
                </div>

                <!-- Alamat -->
                @if($tendik->nama_lembaga)
                <div class="flex items-start">
                    <svg class="w-5 h-5 text-gray-400 mr-2 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M10.707 2.293a1 1 0 00-1.414 0l-7 7a1 1 0 001.414 1.414L4 10.414V17a1 1 0 001 1h2a1 1 0 001-1v-2a1 1 0 011-1h2a1 1 0 011 1v2a1 1 0 001 1h2a1 1 0 001-1v-6.586l.293.293a1 1 0 001.414-1.414l-7-7z"/>
                    </svg>
                    <p class="text-sm text-gray-600 dark:text-gray-400 line-clamp-3">{{ $tendik->nama_lembaga }}</p>
                </div>
                @endif
