        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="bg-white/10 backdrop-blur rounded-lg p-4">
                <div class="flex items-center">
                    ...
                    <div>
                        <p class="text-sm text-violet-100">Total Tendik</p>
        ...
        <div class="lg:col-span-3">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white dark:bg-zinc-800 rounded-lg shadow hover:shadow-xl hover:translate-y-[-2px] transition-all duration-300 overflow-hidden border border-transparent hover:border-violet-200 dark:hover:border-violet-900">
                    <a href="{{ route('guest.tendik.show', $t) }}{{ request()->getQueryString() ? ('?' . request()->getQueryString()) : '' }}" class="block h-full">
                        <!-- Header Card -->
                        <div class="px-4 py-4">
                            @if($t->foto)
                            @php
                    ...
                    @endif
                        ...
                        <div class="p-4 space-y-3">
                            ...
                            <div class="flex items-start">
                                ...
                                <div class="text-sm">
                                    <p class="font-medium text-gray-900 dark:text-white">{{ $t->kabupaten->kabupaten ?? '-' }}</p>
                                </div>
                            </div>
                        </div>
                    </a>
