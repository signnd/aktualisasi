<x-app-layout>
    <x-slot name="header">
        <h2 class="text-xl font-semibold leading-tight text-gray-900 dark:text-gray-200">
            {{ __('Daftar Tenaga Kependidikan (Tendik)') }}
        </h2>
    </x-slot>
    ...
    <div class="py-6" x-data="{ kabupatenId: '{{ $selectedKabupatenId ?? '' }}' }">
        ...
        <div class="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <h3 class="text-2xl font-bold">Data Tenaga Kependidikan Agama Buddha</h3>
        ...
        <!-- Table Content pindah ke livewire/tendik-search.blade.php -->

    <!-- Livewire Component -->
    @livewire('tendik-search')</form>
